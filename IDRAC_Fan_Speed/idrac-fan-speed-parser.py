...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description = 'IDRAC Fan Speed CSV Parser')
    parser.add_argument("-i", "--input_csv", help="Input CSV File from IDRAC Fan Speed", type=str)
    parser.add_argument("-o","--output_csv", help="Output CSV File from IDRAC Fan Speed", type=str)
